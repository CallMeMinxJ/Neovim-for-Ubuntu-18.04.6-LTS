     CC_FOR_BUILD='/root/.ppkg/core/wrapper-native-cc'
   OBJC_FOR_BUILD='/root/.ppkg/core/wrapper-native-objc'
    CXX_FOR_BUILD='/root/.ppkg/core/wrapper-native-c++'
...
CCFLAGS_FOR_BUILD=''
LDFLAGS_FOR_BUILD='-Wl,--as-needed -Wl,-z,muldefs -Wl,--allow-multiple-definition -Wl,-S -L/root/.ppkg/core/lib'
