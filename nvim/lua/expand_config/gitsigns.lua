...
vim.api.nvim_create_user_command("GitSignsNextHunk", function()
	require("gitsigns").next_hunk() -- 跳到下一个 hunk
end, { desc = "Jump to next hunk" })

vim.api.nvim_create_user_command("GitSignsPrevHunk", function()
	require("gitsigns").prev_hunk() -- 跳到上一个 hunk
end, { desc = "Jump to previous hunk" })

vim.api.nvim_create_user_command("GitSignsStageHunk", function()
	require("gitsigns").stage_hunk() -- 阶段化当前变动
end, { desc = "Stage current hunk" })

vim.api.nvim_create_user_command("GitSignsUndoStageHunk", function()
	require("gitsigns").undo_stage_hunk() -- 撤销阶段化当前变动
end, { desc = "Undo stage current hunk" })

vim.api.nvim_create_user_command("GitSignsPreviewHunk", function()
...
vim.api.nvim_create_user_command("GitSignsDiffThis", function()
	require("gitsigns").diffthis() -- 查看当前文件的 diff
end, { desc = "Show current file diff" })
